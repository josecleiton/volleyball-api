...
export class PontuacaoViewApenasClassificatoria1657305148173
  implements MigrationInterface
{
  name = 'PontuacaoViewApenasClassificatoria1657305148173';
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`DROP MATERIALIZED VIEW "pontuacoes_view"`);
    await queryRunner.query(`CREATE MATERIALIZED VIEW "pontuacoes_view" AS WITH total_pontos_ep AS (
      SELECT 
        ep.id AS id,
        COALESCE(SUM((value->>'quantidade')::int),0) as total_pontos
      FROM equipes_partidas AS ep
