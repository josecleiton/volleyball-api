...
export class CadastrarParticipantesPartidaDto {
  ...
  @IsArray()
  @ArrayMinSize(Partida.máximoDeÁrbitrosPrimários)
  @ArrayMaxSize(Partida.máximoDeÁrbitros)
  @ValidateNested({ each: true })
  @Type(() => ArbitroPartidaDto)
  arbitros!: ArbitroPartidaDto[];

  @IsArray()
  @ArrayMinSize(Partida.mínimoDeAtletasNaPartida)
  @ArrayMaxSize(Partida.máximoDeAtletasNaPartida)
  @ValidateNested({ each: true })
